...
var ServiceObject = /** @class */ (function (_super) {
    ...
    function ServiceObject(config) {
        ...
        _this.requestModule = config.requestModule;
        if (config.methods) {
    ...
    ServiceObject.prototype.delete = function (callback) {
        ...
        this.request(reqOpts).then(function (res) { return callback(null, res); }, callback);
    };
    ...
    ServiceObject.prototype.getMetadata = function (callback) {
        var _this = this;
        var methodConfig = (typeof this.methods.getMetadata === 'object' &&
    ...
    ServiceObject.prototype.setMetadata = function (metadata, callback) {
        var self = this;
        callback = callback || util_1.util.noop;
        var methodConfig = (typeof this.methods.setMetadata === 'object' &&
